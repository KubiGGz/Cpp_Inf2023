...
В обоих случаях созраняется линейная асимптотика алгоритма.
...
```
График зависимости суммарного времени работы функции от количества элементов в массиве при равномерном распределении запросов:
![Текст с описанием картинки](Сstrat(norm)_page-0001.jpg)
Для неравномерного распределения запросов получаем следующую зависимость:
![Текст с описанием картинки](Cstrat(not_ravnom)_page-0001.jpg)
В обоих случаях линейная асимптотика сохранилась.
Как мы можем заметить, независимо от выбора стратегии алгоритм сохраняет свою асимптотическую сложность. При равномерном и неравномерном распределениях асимптотика всё равно остаётся линейной.
